...
static HI_S32  SCENE_GetNumbersInOneLine(HI_CHAR *pszInputLine)
{
    ...
    HI_U32      s32Length = strlen(pszInputLine);
    HI_U64      u64Hex;
...
HI_S32 SCENE_LoadStaticAeRouteEX(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_AEROUTEEX_S *pstStaticAeRouteEx)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstStaticAeRouteEx->au32IntTime[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstStaticAeRouteEx->u32TotalNum; u32IdxM++)
        {
            pstStaticAeRouteEx->au32Again[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstStaticAeRouteEx->u32TotalNum; u32IdxM++)
        {
            pstStaticAeRouteEx->au32Dgain[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstStaticAeRouteEx->u32TotalNum; u32IdxM++)
        {
            pstStaticAeRouteEx->au32IspDgain[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadStaticWdrExposure(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_WDREXPOSURE_S *pstStaticWdrExposure)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstStaticWdrExposure->au32ExpRatio[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadStaticSaturation(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_SATURATION_S *pstStaticSaturation)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < ISP_AUTO_ISO_STRENGTH_NUM; u32IdxM++)
        {
            pstStaticSaturation->au8AutoSat[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadStaticDrc(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_DRC_S *pstStaticDrc)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstStaticDrc->au16ToneMappingValue[u32IdxM] = (HI_U16)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstStaticDrc->au16ColorCorrectionLut[u32IdxM] = (HI_U16)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadStaticDehaze(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_DEHAZE_S *pstStaticDeHaze)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstStaticDeHaze->au8DehazeLut[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadDynamicThreeDNR(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_THREEDNR_S *pstDynamicThreeDnr)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstDynamicThreeDnr->au32ThreeDNRIso[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadDynamicLDCI(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_LDCI_S *pstDynamicLdci)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLdci->u32EnableCnt; u32IdxM++)
        {
            pstDynamicLdci->au8Enable[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadDynamicDehaze(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_DEHAZE_S *pstDynamicDehaze)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicDehaze->u32ExpThreshCnt; u32IdxM++)
        {
            pstDynamicDehaze->au8ManualStrength[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadDynamicFsWdr(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_FSWDR_S *pstDynamicFsWdr)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstDynamicFsWdr->au32ExpRation[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicFsWdr->u32IsoCnt; u32IdxM++)
        {
            pstDynamicFsWdr->au8MotionComp[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicFsWdr->u32IsoCnt; u32IdxM++)
        {
            pstDynamicFsWdr->au32ISOLtoHThresh[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicFsWdr->u32IsoCnt; u32IdxM++)
        {
            pstDynamicFsWdr->au8BnrStr[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicFsWdr->u32IsoCnt; u32IdxM++)
        {
            pstDynamicFsWdr->au8BnrMode[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicFsWdr->u32IsoCnt; u32IdxM++)
        {
            pstDynamicFsWdr->au32ISOModeChange[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
        ...
        if (HI_NULL != pszString)
        {
            ...
            for (u32IdxM = 0; u32IdxM < pstDynamicFsWdr->u32IsoCnt; u32IdxM++)
            {
                pstDynamicFsWdr->au8MergeMode[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
            }
            free(pszString);
            pszString = HI_NULL;
        }
...
HI_S32 SCENE_LoadDynamicAE(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_AE_S *pstDynamicAe)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicAe->u8AEExposureCnt; u32IdxM++)
        {
            pstDynamicAe->au8AutoCompensation[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicAe->u8AEExposureCnt; u32IdxM++)
        {
            pstDynamicAe->au8AutoMaxHistOffset[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicAe->u8AEExposureCnt; u32IdxM++)
        {
            pstDynamicAe->au32AutoExpRatioMax[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicAe->u8AEExposureCnt; u32IdxM++)
        {
            pstDynamicAe->au32AutoExpRatioMin[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadStaticSharpen(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_SHARPEN_S *pstStaticSharpen)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstStaticSharpen->au8OverShoot[i] = (HI_U8)s_as64LineNum[i];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++)
        {
            pstStaticSharpen->au8UnderShoot[i] = (HI_U8)s_as64LineNum[i];
...
HI_S32 SCENE_LoadStaticDemosaic(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_DEMOSAIC_S *pstStaticDemosaic)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++)
        {
            pstStaticDemosaic->au8NonDirMFDetailEhcStr[i] = (HI_U8)s_as64LineNum[i];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadDynamicBayernr(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_BAYERNR_S *pstDynamicBayernr)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstDynamicBayernr->au32IsoLevel[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
        ...
        if (HI_NULL != pszString)
        {
            ...
            for (u32IdxM = 0; u32IdxM < ISP_AUTO_ISO_STRENGTH_NUM; u32IdxM++)
            {
                pstDynamicBayernr->au16CoringWgt[u32IdxM] = (HI_U16)s_as64LineNum[u32IdxM];
            }
            free(pszString);
            pszString = HI_NULL;
        }
        ...
        if (HI_NULL != pszString)
        {
            ...
            for (u32IdxM = 0; u32IdxM < ISP_AUTO_ISO_STRENGTH_NUM; u32IdxM++)
            {
                pstDynamicBayernr->au8FineStr[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
            }
            free(pszString);
            pszString = HI_NULL;
        }
...
HI_S32 SCENE_LoadStaticDetail(const HI_CHAR *pszIniModule, HI_SCENE_STATIC_DETAIL_S *pstStaticDetail)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (i = 0; i < ISP_AUTO_ISO_STRENGTH_NUM; i++)
        {
            pstStaticDetail->au16GlobalGain[i] = (HI_U16)s_as64LineNum[i];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadDynamicLinearDrc(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_LINEARDRC_S *pstDynamicLinearDrc)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstDynamicLinearDrc->au32ISOLevel[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8LocalMixingBrightMax[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8LocalMixingBrightMin[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8LocalMixingDarkMax[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8LocalMixingDarkMin[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8BrightGainLmt[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8BrightGainLmtStep[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8DarkGainLmtY[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8DarkGainLmtC[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8ContrastControl[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->as8DetailAdjustFactor[u32IdxM] = (HI_S8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8Asymmetry[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8SecondPole[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8Compress[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au8Stretch[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstDynamicLinearDrc->u32ISOCount; u32IdxM++)
        {
            pstDynamicLinearDrc->au16Strength[u32IdxM] = (HI_U16)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadThreadDrc(const HI_CHAR *pszIniModule, HI_SCENE_THREAD_DRC_S *pstThreadDrc)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstThreadDrc->au32RationLevel[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstThreadDrc->au32RefRatioLtoH[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32RefRatioCount; u32IdxM++)
        {
            pstThreadDrc->u32RefRatioAlpha[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstThreadDrc->au32ISOLevel[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < HI_ISP_DRC_TM_NODE_NUM; u32IdxM++)
        {
            pstThreadDrc->au16TMValueLow[u32IdxM] = (HI_U16)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < HI_ISP_DRC_TM_NODE_NUM; u32IdxM++)
        {
            pstThreadDrc->au16TMValueHigh[u32IdxM] = (HI_U16)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8LocalMixingBrightMax[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8LocalMixingBrightMin[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8LocalMixingDarkMax[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8LocalMixingDarkMin[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8DarkGainLmtY[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8DarkGainLmtC[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->as8DetailAdjustFactor[u32IdxM] = (HI_S8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8SpatialFltCoef[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8RangeFltCoef[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8GradRevMax[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8GradRevThr[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8Compress[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
    ...
    if (HI_NULL != pszString)
    {
        ...
        for (u32IdxM = 0; u32IdxM < pstThreadDrc->u32ISOCount; u32IdxM++)
        {
            pstThreadDrc->au8Stretch[u32IdxM] = (HI_U8)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
...
HI_S32 SCENE_LoadDynamicVencBitrate(const HI_CHAR *pszIniModule, HI_SCENE_DYNAMIC_VENCBITRATE_S *pstDynamicVenc)
{
    ...
    if (HI_NULL != pszString)
    {
        ...
        {
            pstDynamicVenc->au32IsoThreshLtoH[u32IdxM] = (HI_U32)s_as64LineNum[u32IdxM];
        }
        free(pszString);
        pszString = HI_NULL;
    }
