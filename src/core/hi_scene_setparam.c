...
HI_S32 HI_SCENE_SetDynamicVencBitrate_AutoGenerate(VI_PIPE ViPipe, HI_U64 u64Iso, HI_U64 u64LastIso, HI_U8 u8Index)
{
    ...
    HI_U32 u32ExpLevel = 0;
    HI_S32 s32Ret = HI_SUCCESS;
    HI_U32 u32Iso = (HI_U32)u64Iso;
    HI_U32 u32LastIso = (HI_U32)u64LastIso;
...
HI_S32 HI_SCENE_SetDynamicThreeDNR_AutoGenerate(VI_PIPE ViPipe, VPSS_GRP VpssGrp, HI_U32 u32ISO, HI_U32 u32LastISO, HI_U8 u8Index)
{
    ...
    if (u32ISO != u32LastISO)
    {
        ...
        {
            if (u32IsoLevel < g_astScenePipeParam[u8Index].stDynamicThreeDNR.u32ThreeDNRCount)
            {
                stViPipeAttr.bNrEn = HI_FALSE;
                stDEAttr.bEnable = HI_TRUE;
            }
...
HI_S32 HI_SCENE_SetDynamicAE_AutoGenerate(VI_PIPE ViPipe, HI_U64 u64Exposure, HI_U64 u64LastExposure, HI_U8 u8Index)
{
    ...
    if (u64Exposure != u64LastExposure)
    {
        ...
        {
            stExposureAttr.stAuto.u8Compensation = SCENE_Interpulate((HI_U32)u64Exposure,
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au8AutoCompensation[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel + 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au8AutoCompensation[u32ExpLevel + 1]);
        ...
        {
            stExposureAttr.stAuto.u8MaxHistOffset = SCENE_Interpulate((HI_U32)u64Exposure,
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au8AutoMaxHistOffset[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel + 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au8AutoMaxHistOffset[u32ExpLevel + 1]);
        ...
        {
            stWdrExposureAttr.u32ExpRatioMax = SCENE_Interpulate((HI_U32)u64Exposure,
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au32AutoExpRatioMax[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel + 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au32AutoExpRatioMax[u32ExpLevel + 1]);
        }
        ...
        {
            stWdrExposureAttr.u32ExpRatioMin = SCENE_Interpulate((HI_U32)u64Exposure,
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au32AutoExpRatioMin[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au64ExpLtoHThresh[u32ExpLevel + 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicAe.au32AutoExpRatioMin[u32ExpLevel + 1]);
        }
...
HI_S32 HI_SCENE_SetDynamicShading_AutoGenerate(VI_PIPE ViPipe, HI_U64 u64Exposure, HI_U64 u64LastExposure, HI_U8 u8Index)
{
    ...
    if (u64Exposure != u64LastExposure)
    {
        ...
        {
            stShadingAttr.u16MeshStr = SCENE_Interpulate((HI_U32)u64Exposure,
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicShading.au64ExpThreshLtoH[u32ExpLevel - 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicShading.au16ManualStrength[u32ExpLevel - 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicShading.au64ExpThreshLtoH[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicShading.au16ManualStrength[u32ExpLevel]);
        }
...
HI_S32 HI_SCENE_SetDynamicDehaze_AutoGenerate(VI_PIPE ViPipe, HI_U64 u64Exposure, HI_U64 u64LastExposure, HI_U8 u8Index)
{
    ...
    if (u64Exposure != u64LastExposure)
    {
        ...
        {
            stDehazeAttr.stManual.u8strength = SCENE_Interpulate((HI_U32)u64Exposure,
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicDehaze.au64ExpThreshLtoH[u32ExpLevel - 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicDehaze.au8ManualStrength[u32ExpLevel - 1],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicDehaze.au64ExpThreshLtoH[u32ExpLevel],
                (HI_U32)g_astScenePipeParam[u8Index].stDynamicDehaze.au8ManualStrength[u32ExpLevel]);
        }
